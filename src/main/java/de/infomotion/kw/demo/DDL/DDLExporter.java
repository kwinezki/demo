package de.infomotion.kw.demo.DDL;
...
public class DDLExporter {
	...
	public static final String PACKAGE = "de.infomotion.kw.demo.model";
	...
	private Properties createHibernateProperties() {
		...
		hibernateProperties.put(DIALECT, Oracle12cDialect.class.getName());
